...
class Surrugate2(object):
    ...
    def refresh_data(self):
        ...
        self.Y=Branin.AckleyFunction2(self.X).reshape(N,1)
...
if __name__ == '__main__':
    ...
    if flag == 0 :
        ...
        Y_real = Branin.AckleyFunction2(shishi.X[0,:])
        ...
        MSE = Branin.ceshi2D(Branin.AckleyFunction2,shishi.predict)
        time_end = time.time()
